...
def graph():
        ...
        #api_url = 'https://www.quandl.com/api/v3/datasets/WIKI/'+app.vars['ticker']
        # + '.json?start_date=' + start_date + '&end_date=' + crnt_date + '?api_key=tX-ANP6Rh24Q81bFsYH5'
        ...
        return 'redirect works with time and api %s'%(app_vars['ticker'])
